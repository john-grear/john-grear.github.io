...
Minecraft opened the door to my passion for programming. My journey began a couple of years before my enrollment at Wright State in 2019. Delving into the game's intricacies, I started crafting plugins. These plugins found their home on my personal server, where I blended classroom knowledge with practical application to enhance the gameplay for anyone on my server. Regrettably, I couldn't manage to run a server, create plugins, and keep up with college studies, which eventually led to the server's closure after several years.

Among the plugins I crafted were:
...
Also, my server was named Pandamonium and the theme was pandas, which is why my some of the names start with Pandamonium.